...
class FarmerRegistrationView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            farmer_data = Farmer(user=user, User_name=User_name, First_name=First_name, Last_name=Last_name,
...
class VenderRegistrationView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            locality = form.cleaned_data.get('locality')
            zipcode = form.cleaned_data.get('zipcode')
            vendor_data = Vendor(user=user, User_name=User_name, First_name=First_name, Last_name=Last_name,
                                 email=email, phone=phone,
                                 state=state, city=city, locality=locality, zipcode=zipcode)
            print("maff")
...
class ProductView(View):
    def get(self, request):
        ...
        return render(request, 'Jai_Kisan/home.html',
                      {'tracter': tracter, 'boring_machine': boring_machine, 'harvestor': harvestor,
                       'cultivator': cultivator, 'totalitem': totalitem})
...
class ProductDetailView(View):
    def get(self, request, pk):
        ...
        return render(request, 'Jai_Kisan/productdetail.html',
    ...
    if request.user.is_authenticated:
        ...
        if cart_product:
            for p in cart_product:
                ...
                amount += tempamount
            totalamount = amount + shipping_amount
            return render(request, 'Jai_Kisan/addtocart.html',
...
class ProfileView(View):
    def get(self, request):
        ...
        return render(request, 'Jai_Kisan/profile.html',
